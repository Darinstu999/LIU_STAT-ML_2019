# Solutions to the special task of 732A99/TDDE01 Machine Learning
...
#   flush.console()
# 
#   partial_w_j <- rep(0, 10)
#   partial_b_j <- rep(0, 10)
#   partial_w_k <- rep(0, 10)
#   partial_b_k <- 0
# 
#   for(n in 1:nrow(tr)) {
# 
...
#     d_k <- y_k - tr[n,]$Sin
#     d_j <- (1 - z_j^2) * w_k * d_k
#     partial_w_k <- partial_w_k + d_k * z_j
#     partial_b_k <- partial_b_k + d_k
#     partial_w_j <- partial_w_j + d_j * tr[n,]$Var
#     partial_b_j <- partial_b_j + d_j
# 
#   }
# 
#   w_k <- w_k - l_rate * partial_w_k
